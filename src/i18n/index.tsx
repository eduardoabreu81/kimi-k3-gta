...
// Persiste em localStorage ('gtamini.lang'), default 'en', sincroniza
...
const pt = {
  ...
  game: {
    ...
    touch: {
      ...
      exit: 'SAIR',
      enter: 'ENTRAR',
      rotateTitle: 'VIRE O CELULAR',
      rotateSub: 'em paisagem o jogo fica bem melhor',
      rotateDismiss: 'agora não',
    },
    stars: {
...
const en: Dict = {
  ...
  game: {
    ...
    touch: {
      ...
      rotateSub: 'way better in landscape',
      rotateDismiss: 'not now',
    },
    stars: {
...
function readStoredLang(): Lang {
  ...
  return 'en' // idioma principal: inglês (pedido do usuário)
}
